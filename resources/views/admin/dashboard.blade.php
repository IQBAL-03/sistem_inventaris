        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                <div class="relative overflow-hidden group">
                    ...
                    <div class="relative p-10 flex items-center justify-between">
                        <div>
                            <p class="text-indigo-100 text-sm font-bold uppercase tracking-widest mb-1 opacity-80">Total Inventaris</p>
                            <h3 class="text-6xl font-black text-white leading-none">{{ $totalItems }}</h3>
                            <p class="text-indigo-100 text-xs mt-4 font-medium">Barang tersedia di lab</p>
                        </div>
                ...
                <div class="relative overflow-hidden group">
                    ...
                    <div class="relative p-10 flex items-center justify-between">
                        <div>
                            <p class="text-fuchsia-100 text-sm font-bold uppercase tracking-widest mb-1 opacity-80">Peminjaman Aktif</p>
                            <h3 class="text-6xl font-black text-white leading-none">{{ $activeBorrowings }}</h3>
                            <p class="text-fuchsia-100 text-xs mt-4 font-medium">Permintaan tertunda atau disetujui</p>
                        </div>
                        <div class="p-6 bg-white/10 backdrop-blur-xl rounded-[2.5rem] border border-white/20 text-white shadow-inner transform group-hover:-rotate-12 transition-transform duration-500">
                            <svg class="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-10">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <h3 class="text-2xl font-black text-gray-900 uppercase tracking-tighter">Akses <span class="text-indigo-600">Cepat</span></h3>
                        <p class="text-gray-500 text-sm mt-1 font-medium">Akses langsung ke fitur manajemen utama.</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-gray-900">
                    <a href="{{ route('admin.items.index') }}" class="group p-8 rounded-[2rem] bg-indigo-50 border border-indigo-100 hover:bg-indigo-600 transition-all duration-300">
                        ...
                        <p class="text-gray-600 group-hover:text-indigo-100 transition-colors mt-2 text-sm font-medium">Tambah, ubah, atau hapus item peralatan lab.</p>
                    </a>
                    ...
                    <a href="{{ route('admin.categories.index') }}" class="group p-8 rounded-[2rem] bg-purple-50 border border-purple-100 hover:bg-purple-600 transition-all duration-300">
                        ...
                        <p class="text-gray-600 group-hover:text-purple-100 transition-colors mt-2 text-sm font-medium">Atur barang kedalam kategori yang efisien.</p>
                    </a>
                    ...
                    <a href="{{ route('admin.borrowings.index') }}" class="group p-8 rounded-[2rem] bg-pink-50 border border-pink-100 hover:bg-pink-600 transition-all duration-300">
                        ...
                        <p class="text-gray-600 group-hover:text-pink-100 transition-colors mt-2 text-sm font-medium">Setujui, tolak, atau kelola peminjaman aktif.</p>
                    </a>
                </div>
            </div>
        </div>
