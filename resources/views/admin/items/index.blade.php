                        ...
                        <table class="min-w-full divide-y divide-gray-200/30">
                            <thead>
                                <tr class="text-left">
                                    ...
                                    <th class="px-6 py-4 text-xs font-black text-gray-400 uppercase tracking-[0.2em]">Category</th>
                                    <th class="px-6 py-4 text-xs font-black text-gray-400 uppercase tracking-[0.2em]">Brand/Merk</th>
                                    <th class="px-6 py-4 text-xs font-black text-gray-400 uppercase tracking-[0.2em]">Stock</th>
