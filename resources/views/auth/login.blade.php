    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5" x-data="{ showPassword: false }">
        ...
        <div class="space-y-1.5">
            ...
            <div class="relative group">
                ...
                <x-text-input id="email" class="block w-full pl-11 pr-4 py-3 bg-white border-slate-200 focus:border-blue-500 focus:ring-blue-500/20 rounded-2xl transition-all" type="email" name="email" :value="old('email')" required autofocus placeholder="nama@sekolah.sch.id" />
            </div>
        ...
        <div class="space-y-1.5">
            ...
            <div class="relative group">
                ...
                <x-text-input id="password" class="block w-full pl-11 pr-12 py-3 bg-white border-slate-200 focus:border-blue-500 focus:ring-blue-500/20 rounded-2xl transition-all"
